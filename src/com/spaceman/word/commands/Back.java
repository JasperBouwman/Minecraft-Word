											...
											for (int xx3 = minX3; xx3 <= maxX3; xx3++) {
												for (int yy3 = minY3; yy3 <= maxY3; yy3++) {
													for (int zz3 = minZ3; zz3 <= maxZ3; zz3++) {
														Block block3 = Bukkit.getServer()
																.getWorld(l.getWorld().getName())
														...
														if (block3.getType().equals(p.getConfig()
																.getItemStack("word.material").getType())) {
															material = true;
														} else if (bool) {
															i3++;
															bool = false;
								...
								for (int yy = minY; yy <= maxY; yy++) {
									for (int zz = minZ; zz <= maxZ; zz++) {
										...
										if (block.getType().equals(
												p.getConfig().getItemStack("word.material").getType()) && loop2) {
											i++;
											loop2 = false;
										} else {
											ii++;
